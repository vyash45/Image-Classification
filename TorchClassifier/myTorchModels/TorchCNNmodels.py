...
class MLP(nn.Module): #for MNIST dataset
    def __init__(self, input_dim, output_dim):
        ...
        self.bn1 = nn.BatchNorm1d(250)  # Batch Normalization after first layer
        self.dropout1 = nn.Dropout(0.25)  # Dropout after first activation
        
        self.hidden_fc = nn.Linear(250, 100)
        self.bn2 = nn.BatchNorm1d(100)  # Batch Normalization after second layer
        self.dropout2 = nn.Dropout(0.25)  # Dropout after second activation
